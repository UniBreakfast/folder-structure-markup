...
## [🔝](#folder-structure-markup) Tree Object Format
...
### [🔝](#folder-structure-markup) `readDirStructure(?path, ?ignoreNames)`
...
### [🔝](#folder-structure-markup) `makeDirStructure(tree, ?path)`
...
### [🔝](#folder-structure-markup) `stringifyDirStructure(tree)`
